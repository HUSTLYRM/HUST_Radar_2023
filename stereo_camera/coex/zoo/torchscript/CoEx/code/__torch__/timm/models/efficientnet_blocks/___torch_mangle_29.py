class InvertedResidual(Module):
  ...
  se : None
  conv_pw : __torch__.torch.nn.modules.conv.___torch_mangle_19.Conv2d
  bn1 : __torch__.torch.nn.modules.batchnorm.___torch_mangle_20.BatchNorm2d
  act1 : __torch__.torch.nn.modules.activation.ReLU6
  conv_dw : __torch__.torch.nn.modules.conv.___torch_mangle_26.Conv2d
  bn2 : __torch__.torch.nn.modules.batchnorm.___torch_mangle_20.BatchNorm2d
  act2 : __torch__.torch.nn.modules.activation.ReLU6
  conv_pwl : __torch__.torch.nn.modules.conv.___torch_mangle_27.Conv2d
  bn3 : __torch__.torch.nn.modules.batchnorm.___torch_mangle_28.BatchNorm2d
  def forward(self: __torch__.timm.models.efficientnet_blocks.___torch_mangle_29.InvertedResidual,
    x: Tensor) -> Tensor:
