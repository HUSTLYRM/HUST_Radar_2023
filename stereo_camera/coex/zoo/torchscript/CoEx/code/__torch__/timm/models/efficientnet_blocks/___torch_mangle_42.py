class InvertedResidual(Module):
  ...
  conv_dw : __torch__.torch.nn.modules.conv.___torch_mangle_40.Conv2d
  bn2 : __torch__.torch.nn.modules.batchnorm.___torch_mangle_39.BatchNorm2d
  act2 : __torch__.torch.nn.modules.activation.ReLU6
  conv_pwl : __torch__.torch.nn.modules.conv.___torch_mangle_41.Conv2d
  bn3 : __torch__.torch.nn.modules.batchnorm.___torch_mangle_5.BatchNorm2d
  def forward(self: __torch__.timm.models.efficientnet_blocks.___torch_mangle_42.InvertedResidual,
    x: Tensor) -> Tensor:
