class InvertedResidual(Module):
  ...
  conv_pwl : __torch__.torch.nn.modules.conv.___torch_mangle_33.Conv2d
  bn3 : __torch__.torch.nn.modules.batchnorm.___torch_mangle_28.BatchNorm2d
  def forward(self: __torch__.timm.models.efficientnet_blocks.___torch_mangle_34.InvertedResidual,
    x: Tensor) -> Tensor:
