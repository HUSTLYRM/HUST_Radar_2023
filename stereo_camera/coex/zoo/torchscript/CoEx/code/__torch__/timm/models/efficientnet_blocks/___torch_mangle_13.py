class InvertedResidual(Module):
  ...
  conv_dw : __torch__.torch.nn.modules.conv.___torch_mangle_11.Conv2d
  bn2 : __torch__.torch.nn.modules.batchnorm.___torch_mangle_10.BatchNorm2d
  act2 : __torch__.torch.nn.modules.activation.ReLU6
  conv_pwl : __torch__.torch.nn.modules.conv.___torch_mangle_12.Conv2d
  bn3 : __torch__.torch.nn.modules.batchnorm.___torch_mangle_8.BatchNorm2d
  def forward(self: __torch__.timm.models.efficientnet_blocks.___torch_mangle_13.InvertedResidual,
    x: Tensor) -> Tensor:
