class InvertedResidual(Module):
  ...
  conv_dw : __torch__.torch.nn.modules.conv.___torch_mangle_21.Conv2d
  bn2 : __torch__.torch.nn.modules.batchnorm.___torch_mangle_20.BatchNorm2d
  act2 : __torch__.torch.nn.modules.activation.ReLU6
  conv_pwl : __torch__.torch.nn.modules.conv.___torch_mangle_22.Conv2d
  bn3 : __torch__.torch.nn.modules.batchnorm.BatchNorm2d
  def forward(self: __torch__.timm.models.efficientnet_blocks.___torch_mangle_23.InvertedResidual,
    x: Tensor) -> Tensor:
