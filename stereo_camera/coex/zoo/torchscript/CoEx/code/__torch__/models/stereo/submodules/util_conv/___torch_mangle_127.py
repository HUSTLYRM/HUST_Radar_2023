class BasicConv(Module):
  ...
  relu : bool
  use_bn : bool
  conv : __torch__.torch.nn.modules.conv.___torch_mangle_126.Conv3d
  ...
  def forward(self: __torch__.models.stereo.submodules.util_conv.___torch_mangle_127.BasicConv,
    x: Tensor) -> Tensor:
