class BasicConv(Module):
  ...
  relu : bool
  use_bn : bool
  conv : __torch__.torch.nn.modules.conv.___torch_mangle_119.ConvTranspose3d
  ...
  def forward(self: __torch__.models.stereo.submodules.util_conv.___torch_mangle_120.BasicConv,
    x: Tensor) -> Tensor:
