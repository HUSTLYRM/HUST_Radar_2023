class BasicConv(Module):
  ...
  relu : bool
  use_bn : bool
  conv : __torch__.torch.nn.modules.conv.___torch_mangle_82.Conv2d
  bn : __torch__.torch.nn.modules.batchnorm.BatchNorm2d
  LeakyReLU : __torch__.torch.nn.modules.activation.LeakyReLU
  def forward(self: __torch__.models.stereo.submodules.util_conv.___torch_mangle_83.BasicConv,
    x: Tensor) -> Tensor:
