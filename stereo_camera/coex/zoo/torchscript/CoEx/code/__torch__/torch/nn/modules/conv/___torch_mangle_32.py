class Conv2d(Module):
  ...
  out_channels : Final[int] = 384
  kernel_size : Final[Tuple[int, int]] = (3, 3)
  in_channels : Final[int] = 384
  ...
  def forward(self: __torch__.torch.nn.modules.conv.___torch_mangle_32.Conv2d,
    ...
    return _0
  def _conv_forward(self: __torch__.torch.nn.modules.conv.___torch_mangle_32.Conv2d,
    input: Tensor,
    weight: Tensor,
    bias: Optional[Tensor]) -> Tensor:
    _1 = torch.conv2d(input, weight, bias, [1, 1], [1, 1], [1, 1], 384)
    return _1
