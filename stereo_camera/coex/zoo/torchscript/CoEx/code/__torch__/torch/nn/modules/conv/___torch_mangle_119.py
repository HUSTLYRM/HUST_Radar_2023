class ConvTranspose3d(Module):
  ...
  def forward(self: __torch__.torch.nn.modules.conv.___torch_mangle_119.ConvTranspose3d,
    input: Tensor,
    ...
    return _0
  def _output_padding(self: __torch__.torch.nn.modules.conv.___torch_mangle_119.ConvTranspose3d,
    input: Tensor,
