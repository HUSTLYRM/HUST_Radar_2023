class BatchNorm3d(Module):
  ...
  def forward(self: __torch__.torch.nn.modules.batchnorm.___torch_mangle_111.BatchNorm3d,
    ...
    return _3
  def _check_input_dim(self: __torch__.torch.nn.modules.batchnorm.___torch_mangle_111.BatchNorm3d,
    input: Tensor) -> None:
    if torch.ne(torch.dim(input), 5):
      _4 = torch.format("expected 5D input (got {}D input)", torch.dim(input))
