class BatchNorm3d(Module):
  ...
  def forward(self: __torch__.torch.nn.modules.batchnorm.___torch_mangle_117.BatchNorm3d,
    input: Tensor) -> Tensor:
    ...
    return _3
  def _check_input_dim(self: __torch__.torch.nn.modules.batchnorm.___torch_mangle_117.BatchNorm3d,
    input: Tensor) -> None:
