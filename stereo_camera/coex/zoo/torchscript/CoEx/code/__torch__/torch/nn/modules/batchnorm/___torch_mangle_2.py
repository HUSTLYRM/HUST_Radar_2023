class BatchNorm2d(Module):
  ...
  def forward(self: __torch__.torch.nn.modules.batchnorm.___torch_mangle_2.BatchNorm2d,
    input: Tensor) -> Tensor:
    ...
    return _3
  def _check_input_dim(self: __torch__.torch.nn.modules.batchnorm.___torch_mangle_2.BatchNorm2d,
    input: Tensor) -> None:
