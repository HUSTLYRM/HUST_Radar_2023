class ConvTranspose2d(Module):
  ...
  def forward(self: __torch__.torch.nn.modules.conv.___torch_mangle_63.ConvTranspose2d,
    input: Tensor,
    ...
    return _0
  def _output_padding(self: __torch__.torch.nn.modules.conv.___torch_mangle_63.ConvTranspose2d,
    input: Tensor,
