class Conv3d(Module):
  ...
  def forward(self: __torch__.torch.nn.modules.conv.___torch_mangle_110.Conv3d,
    input: Tensor) -> Tensor:
    _0 = torch.conv3d(input, self.weight, self.bias, [2, 2, 2], [1, 1, 1], [1, 1, 1], 1)
    return _0
