class Conv3d(Module):
  ...
  kernel_size : Final[Tuple[int, int, int]] = (1, 1, 1)
  ...
  padding : Final[Tuple[int, int, int]] = (0, 0, 0)
  groups : Final[int] = 1
  padding_mode : Final[str] = "zeros"
  def forward(self: __torch__.torch.nn.modules.conv.___torch_mangle_126.Conv3d,
    input: Tensor) -> Tensor:
    _0 = torch.conv3d(input, self.weight, self.bias, [1, 1, 1], [0, 0, 0], [1, 1, 1], 1)
    return _0
